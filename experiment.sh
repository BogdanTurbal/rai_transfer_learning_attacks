...
#SBATCH -o /gpfs/work4/0/tese0660/projects/transf_learn_attack/v4/gin_imp_%j.out
...
# Base directory
BASE_DIR="/gpfs/work4/0/tese0660/projects/transf_learn_attack/v4"
...
for i in {0..8}; do
    ...
    python $CODE_DIR/attack_trans.py $BASE_DIR/${i}_id/ $BASE_DIR/ --msl 3 --ne 3 --mae 2600 --mel 0 --seed $seed --run $run --mod_id $mod_id --load_best 1 > $OUT_FILE 2>&1 &
done
